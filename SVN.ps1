...
{ 
    ...
    svn status | Out-GridView -PassThru | ForEach-Object {    
        ...
        svn commit $file -m ' CS-8865 Create Toggle to Show/Hide'; # CS-8494 EINS  CS-8614 CIO
    }    
    $nams = '';
    ...
    svn commit --targets 'C:\temp\svnupdates.txt' -m 'CS-8459 Browser Automator config attribute targets'; notepad.exe 'C:\temp\svnupdates.txt';
